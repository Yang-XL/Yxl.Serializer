...
namespace Yxl.Serializer.MessagePack
{
    ...
    /// </summary>
    public class DefaultMessagePackSerializer : IMessagePackSerializer
    {
        /// <summary>
        /// The name.
        /// </summary>
        ...
        /// The options.
        /// </summary>
        private readonly MsgPackSerializerOptions _options;

        /// <summary>
        /// Initializes a new instance of the
        /// <see cref="T:Yxl.Serializer.MessagePack.DefaultMessagePackSerializer"/> class.
        /// </summary>
        /// <param name="name">Name.</param>
        /// <param name="options">Options.</param>
        public DefaultMessagePackSerializer(string name, MsgPackSerializerOptions options)
        {
            _name = name;
            _options = options;
        ...
        {
            byte[] bytes = MessagePackSerializer.Serialize(value, TypelessContractlessStandardResolver.Options);
